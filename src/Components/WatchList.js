...
function WatchList() {
    ...
    const deleteFavorite = async (movie) => {
        deleteFromFirebase(movie, "My Watchlist Collection");
      }
              ...
              <div className="row">
                  ...
                  <div key={movie.id} className="col-md-3 mb-2 movie-item">
                      ...
                      <div className="favorite-center">
                        <button className="btn btn-primary favorite-center-text" onClick={() =>deleteFavorite(movie.id)}>Remove From Watchlist</button>
                      </div>                     
                      <hr/>
